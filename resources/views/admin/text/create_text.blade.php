    ...
    <div class="container">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="type" method="POST" action="{{ route('store_text')}}">
                        @csrf
                                        ...
                                        <div class="tab-content">
                                            @foreach($languages as $language)
                                                <div class='{{$language === app()->getLocale()? "tab-pane active":"tab-pane"}}' id="{{$language}}" role="tabpanel">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text" class="form-control @error('sub_title_'.$language) is-invalid @enderror" name="sub_title_{{$language}}" value="{{ old('sub_title_'.$language) }}" autocomplete="sub_title_{{$language}}" placeholder={{__('translations.sub_title')}} autofocus>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <textarea type="text" class="form-control @error('text_'.$language) is-invalid @enderror" name="text_{{$language}}" rows="7"  autocomplete="text_{{$language}}" placeholder={{__('translations.text')}} autofocus>{{ old('text_'.$language) }}</textarea>
                                            ...
                                            @endforeach
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 mb-10 mb-sm-10">
                                                        <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ old('slug') }}" autocomplete="slug" placeholder={{__('translations.slug')}} autofocus>
                                                        @error('slug')
                                                        <span class="invalid-feedback" role="alert">
                                                                    <strong>
                                                                        {{ $message }}
