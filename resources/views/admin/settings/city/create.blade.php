        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="h4 m-0 font-weight-bold text-primary text-center">{{__('translations.create')}} {{__('translations.city')}}  </h4>
                </div>
                <div class="card-body">
                    <form class="city" method="POST" action="{{ route('store_city')}}">
                        @csrf
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text"
                                                                   ...
                                                                   placeholder={{__('translations.city')}} autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 mb-10 mb-sm-10">
                                                    <select class="form-select form-control" name="state">
                                                        <option value=""> {{__('translations.state')}}</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 mb-10 mb-sm-10">
                                                    <input type="text"
                                                           ...
                                                           name="coordinates" value="{{ old('coordinates') }}"
                                                           autocomplete="coordinates"
                                                           placeholder={{__('translations.coordinates')}} autofocus>
                                                    @error('coordinates')
                                                    <span class="invalid-feedback" role="alert">
                                                                <strong>
                                                                    {{ $message }}
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 mb-10 mb-sm-10">
                                                    <input type="number"
                                                           ...
                                                           name="map_zoom" value="{{ old('map_zoom') }}"
