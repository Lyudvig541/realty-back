    ...
    <div class="container">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="country" method="POST" action="{{ route('edit_country', $country->id) }}">
                        @csrf
                                    ...
                                    <div class="col-12 nav-tabs-boxed">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class='{{$language === app()->getLocale()? "tab-pane active":"tab-pane"}}' id="{{$language}}" role="tabpanel">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text" class="form-control @error('name_'.$language) is-invalid @enderror" name="name_{{$language}}" value="{{ $country->translate($language)->name }}" autocomplete="name_{{$language}}" placeholder={{__('translations.country')}} autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 mb-10 mb-sm-10">
                                                    <input type="text" class="form-control @error('coordinates') is-invalid @enderror" name="coordinates" value="{{ $country->coordinates }}" autocomplete="coordinates" placeholder='Coordinates' autofocus>
                                                    @error('coordinates')
                                                    <span class="invalid-feedback" role="alert">
                                                            <strong>
                                                                {{ $message }}
