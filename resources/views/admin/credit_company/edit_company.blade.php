...
@section('content')
    <div class="container">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="company" method="POST" action="{{ route('edit_company', $company->id)}}" enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class='{{$language === app()->getLocale()? "tab-pane active":"tab-pane"}}' id="{{$language}}" role="tabpanel">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text" class="form-control @error('name_'.$language) is-invalid @enderror" name="name_{{$language}}" value="{{$company->translate($language)->name}}" autocomplete="name_{{$language}}" placeholder="{{__('translations.company_name')}}" autofocus>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <textarea type="text" class="form-control @error('description_'.$language) is-invalid @enderror" name="description_{{$language}}" autocomplete="description_"{{$language}} placeholder="{{ __('translations.description') }}" autofocus>{{$company->translate($language)->description}}</textarea>
                                            ...
                                            @endforeach
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 mb-10 mb-sm-10">
                                                        <input id="phone" class="form-control file-input @error('phone') is-invalid @enderror" type="number" name="phone" value="{{$company->phone}}" placeholder="{{ __('translations.phone') }}">
                                                        @error('phone')
                                                        <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 mb-10 mb-sm-10">
                                                        <input id="phone" value="{{$company->whatsapp}}" class="form-control file-input @error('whatsapp') is-invalid @enderror" type="number" name="whatsapp" placeholder="{{ __('translations.whatsapp') }}">
                                                        @error('whatsapp')
                                                        <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 mb-10 mb-sm-10">
                                                        <input id="phone" value="{{$company->viber}}" class="form-control file-input @error('viber') is-invalid @enderror" type="number" name="viber" placeholder="{{ __('translations.viber') }}">
                                                        @error('viber')
                                                        <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                        ...
                        <div class="card-footer text-center">
                            ...
                            <a href="{{route('companies')}}" class="btn btn-sm btn-danger">
    ...
    <script type="text/javascript">
        ...
        if (image){
            initialPreview = ['/storage/uploads/companies/' + image];
        ...
        $(".kv-file-remove").click(function (e) {
            ...
            e.preventDefault();
            let id = '{{$company->id}}'
            let link = '{{$company->image}}'
            let type = 'image';
            let kv_file = $(this)
            $.ajax({
                type: "post",
                url: "/admin/companies/remove-image",
