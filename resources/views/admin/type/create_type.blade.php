    ...
    <div class="container">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="type" method="POST" action="{{ route('store_type')}}" enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class='{{$language === app()->getLocale()? "tab-pane active":"tab-pane"}}' id="{{$language}}" role="tabpanel">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text" class="form-control @error('name_'.$language) is-invalid @enderror" name="name_{{$language}}" value="{{ old('name_'.$language) }}" autocomplete="name_{{$language}}" placeholder={{__('translations.type_name')}} autofocus>
                                            ...
                                            @endforeach
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 mb-10 mb-sm-10">
                                                        <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ old('slug_'.$language) }}" autocomplete="slug" placeholder={{__('translations.slug')}} autofocus>
                                                        @error('slug')
                                                        <span class="invalid-feedback" role="alert">
                                                                    <strong>
                                                                        {{ $message }}
