...
@section('content')
    <div class="container">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="facilities" method="POST" action="{{ route('edit_facility', $facility->id)}}" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="col-12 nav-tabs-boxed">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class='{{$language === app()->getLocale()? "tab-pane active":"tab-pane"}}' id="{{$language}}" role="tabpanel">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text" class="form-control @error('title_'.$language) is-invalid @enderror" name="title_{{$language}}" value="{{ $facility->translate($language)->title }}" autocomplete="title_{{$language}}" placeholder="{{__('translations.title')}}" autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 mb-10 mb-sm-10">
                                                    <input type="text" class="form-control @error('value') is-invalid @enderror" name="value" value="{{ $facility->value }}" autocomplete="value" placeholder="{{__('translations.value')}}" autofocus>
                                                    @error('value')
                                                    <span class="invalid-feedback" role="alert">
                                                            <strong>
                                                                {{ $message }}
                        ...
                        <div class="card-footer text-center">
                            ...
                            <a href="{{route('facilities')}}" class="btn btn-sm btn-danger">
    ...
    <script type="text/javascript">
        ...
        if (image){
            initialPreview = ['/storage/uploads/facilities/' + image];
        ...
        $(".kv-file-remove").click(function (e) {
            ...
            e.preventDefault();
            let id = '{{$facility->id}}'
            let link = '{{$facility->image}}'
            let type = 'image';
            let kv_file = $(this)
            $.ajax({
                type: "post",
                url: "/admin/facilities/remove-image",
