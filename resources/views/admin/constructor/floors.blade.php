...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/editor/submodules/squares/css/squares.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/squares/css/squares-editor.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/squares/css/squares-controls.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/wcp-editor/css/wcp-editor.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/wcp-form/css/wcp-form.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/wcp-form/css/wcp-form-controls.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/wcp-tour/css/wcp-tour.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/wcp-fontawesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/submodules/wcp-fontawesome/css/wcp-fontawesome.css') }}">

    <link rel="stylesheet" href="{{ asset('/editor/css/image-map-pro-editor.css') }}">
    <link rel="stylesheet" href="{{ asset('/editor/css/image-map-pro.css') }}">
</head>
    <body>
        ...
        <script src="/editor/js/lib/jquery.min.js"></script>
        <script src="/editor/submodules/svg-path-parser/svg-path-parser.js"></script>
        <script src="/editor/submodules/squares/js/squares-renderer.js"></script>
        <script src="/editor/submodules/squares/js/squares.js"></script>
        <script src="/editor/submodules/squares/js/squares-elements-jquery.js"></script>
        <script src="/editor/submodules/squares/js/squares-controls.js"></script>
        <script src="/editor/submodules/wcp-form/js/wcp-form.js"></script>
        <script src="/editor/submodules/wcp-form/js/wcp-form-controls.js"></script>
        <script src="/editor/submodules/wcp-editor/js/wcp-editor.js"></script>
        <script src="/editor/submodules/wcp-tour/js/wcp-tour.js"></script>
        <script src="/editor/submodules/wcp-compress/js/wcp-compress.js"></script>
        <script src="/editor/submodules/wcp-fontawesome/js/wcp-fontawesome.js"></script>
        <script src="/editor/js/image-map-pro-defaults.js"></script>
        <script src="/editor/js/image-map-pro-editor-countries-jquery.js"></script>

        <script type="text/javascript">
            if("{!! $type !!}" === "floor"){
                if("{!! $constructor->floors_id !!}"){
                    const plans = JSON.stringify({!! $constructor->floors !!}).replaceAll("'","\\\"");
                    localStorage.setItem('editor_saves','[' + plans + ']');
                    localStorage.setItem('editor_last_save',{!! $constructor->floors_id !!});
                }else{
                    localStorage.clear();
                }
            }else{
                if("{!! $constructor->plans_id !!}"){
                    const plans = JSON.stringify({!! $constructor->plans !!}).replaceAll("'","\\\"");
                    localStorage.setItem('editor_saves','[' + plans + ']');
                    localStorage.setItem('editor_last_save',{!! $constructor->plans_id !!});
                }else{
                    localStorage.clear();
                }
            }
        ...
        */
            ...
            ;(function ($, window, document, undefined) {
                ...
                $.wcpEditorEventSaveButtonPressed = function() {
                    ...
                    $.imp_editor_storage_store_save(editor.getCompressedSettings(), function(success) {
                        if (success) {
                            let compressedSettings = editor.getCompressedSettings()
                            $.ajaxSetup({
                                headers: {
                            ...
                            let url;
                            if("{{$type}}" === "floor"){
                                 url = "/admin/constructors/save-floors"
                            }else{
                                url = "/admin/constructors/save-plans"
                            }
                            $.ajax({
                                type: "post",
                                url: url,
                                data: {"id": "{{$constructor->id}}","type": "{{$type}}", "plans": JSON.stringify(compressedSettings),"plans_id": compressedSettings.id},
                                dataType: 'json',
                                success: function () {
                                    $.wcpEditorHideLoadingScreenWithMessage('Saved!', false, false);
                                    localStorage.clear();
        ...
        <script src="/editor/js/image-map-pro-editor-content.js"></script>
        <script src="/editor/js/image-map-pro-editor-storage-jquery.js"></script>
        <script src="/editor/js/image-map-pro-editor-init-jquery.js"></script>
        <script src="/editor/js/image-map-pro.js"></script>
