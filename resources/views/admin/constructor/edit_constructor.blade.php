...
@section('content')
    <div class="container">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="announcements" method="POST" id="dropzoneForm" class="dropzone"
                      action="{{ route('edit_constructor',$constructor->id)}}" enctype="multipart/form-data">
                    @csrf
                                ...
                                @foreach($languages as $language)
                                    <div class='{{$language === app()->getLocale()? "tab-pane active":"tab-pane"}}' id="{{$language}}" role="tabpanel">
                                        <div class="form-group row">
                                            <div class="col-sm-3 mb-3 mb-sm-3">
                                                <label class="col-form-label text-gray-900"
                                                       for="property_name_{{$language}}">{{__('translations.property_name')}}</label>
                                            </div>
                                            <div class="col-sm-9 mb-9 mb-sm-9">
                                                <input type="text"
                                                       ...
                                                       value="{{$constructor->translate($language)->property_name}}"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 mb-3 mb-sm-3">
                                                <label class="col-form-label text-gray-900"
                                                       for="sub_title_{{$language}}">{{__('translations.sub_title')}}</label>
                                            </div>
                                            <div class="col-sm-9 mb-9 mb-sm-9">
                                                <input type="text"
                                                       class="form-control @error('sub_title_'.$language) is-invalid @enderror"
                                                       name="sub_title_{{$language}}"
                                                       value="{{$constructor->translate($language)->sub_title}}"
                                                       autocomplete="property_name_{{$language}}"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 mb-3 mb-sm-3">
                                                <label class="col-form-label text-gray-900"
                                                       for="property_description_{{$language}}">
                                                    {{__('translations.description')}}
                                                </label>
                                            </div>
                                            <div class="col-sm-9 mb-9 mb-sm-9">
                                                <div class="md-form">
                                                    <textarea id="property_description_{{$language}}" class="editor md-textarea form-control @error('property_description_'.$language) is-invalid @enderror"
                                                              placeholder="{{__('translations.description')}}" rows="3"
                                                              name="property_description_{{$language}}">{{ $constructor->translate($language)->property_description}}</textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9 mb-9 mb-sm-9">
                                                <div class="md-form">
                                                    <textarea id="features_{{$language}}" class="editor md-textarea form-control @error('features_'.$language) is-invalid @enderror"
                                                              placeholder="{{__('translations.features')}}" rows="3" name="features_{{$language}}">{{ $constructor->translate($language)->features}}</textarea>
                                            ...
                                            <div class="col-sm-9 mb-9 mb-sm-9">
                                                <div class="md-form">
                                                    <textarea id="property_description_{{$language}}"
                                                              ...
                                                              name="renovation_{{$language}}">{{ $constructor->translate($language)->renovation}}</textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 mb-3 mb-sm-3">
                                                <label class="col-form-label text-gray-900" for="floors_{{$language}}">
                                                    Floors
                                                </label>
                                                <br/>
                                                <a href="{{route('floor', [$constructor->translate($language)->id,'type'=>'floor'])}}" target="_blank" class="btn btn-primary btn-info">
                                                    <i class="fab fa-creative-commons-remix"></i>
                                                </a>
                                            </div>
                                            <div class="col-sm-9 mb-9 mb-sm-9">
                                                <div class="md-form">
                                                    <textarea id="floors_{{$language}}"
                                                              class="md-textarea form-control @error('floors_'.$language) is-invalid @enderror"
                                                              placeholder="Floors" rows="5"
                                                              name="floors_{{$language}}">{{$constructor->translate($language)->floors}}</textarea>
                                                    @error('plans_'.$language)
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                    @enderror
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 mb-3 mb-sm-3">
                                                <label class="col-form-label text-gray-900" for="plans_{{$language}}">
                                                    Plans
                                                </label>
                                                <br/>
                                                <a href="{{route('floor', [$constructor->translate($language)->id,'type'=>'plan'])}}" target="_blank" class="btn btn-primary btn-info">
                                                    <i class="fab fa-creative-commons-remix"></i>
                                                </a>
                                            </div>
                                            <div class="col-sm-9 mb-9 mb-sm-9">
                                                <div class="md-form">
                                                    <textarea id="plans_{{$language}}"
                                                              class="md-textarea form-control @error('plans_'.$language) is-invalid @enderror"
                                                              placeholder="Plans" rows="5"
                                                              name="plans_{{$language}}">{{$constructor->translate($language)->plans}}</textarea>
                                                    @error('plans_'.$language)
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3 mb-3 mb-sm-3">
                            <input type="number" class="form-control @error('price_start') is-invalid @enderror"
                                   name="price_start" value="{{$constructor->price_start}}" autocomplete="price_start"
                        ...
                        <div class="col-sm-3 mb-3 mb-sm-3">
                            <input type="number" class="form-control @error('price_end') is-invalid @enderror"
                                   name="price_end" value="{{ $constructor->price_end }}" autocomplete="price_end"
                        ...
                        <div class="col-sm-2 mb-2 mb-sm-2">
                            <select name="currency" class="form-control" id="currency">
                                ...
                                @foreach($currencies as $currency)
                                    <option value="{{$currency->id}}" @if($currency->id ==$constructor->currency_id) selected @endif> {{$currency->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('lot') is-invalid @enderror" name="lot"
                                   value="{{ $constructor->lot}}" autocomplete="lot" placeholder="{{__('translations.lot')}}"
                                   autofocus>
                            @error('lot')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('area') is-invalid @enderror" name="area"
                                   value="{{$constructor->area}}" autocomplete="area" placeholder="{{__('translations.area')}}"
                                   autofocus step="0.01">
                            @error('area')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 mb-4 mb-sm-4">
                            <input type="number" class="form-control @error('min_room') is-invalid @enderror"
                                   name="min_room" value="{{$constructor->min_room}}" autocomplete="min_room"
                                   placeholder="{{__('translations.min_room')}}" autofocus step="0.01">
                            @error('min_room')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-sm-4 mb-4 mb-sm-4">
                            <input type="number" class="form-control @error('max_room') is-invalid @enderror"
                                   name="max_room" value="{{$constructor->max_room}}" autocomplete="max_room"
                                   placeholder="{{__('translations.max_room')}}" autofocus step="0.01">
                            @error('max_room')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('apartment_counts') is-invalid @enderror"
                                   name="apartment_counts" value="{{$constructor->apartment_counts}}" autocomplete="apartment_counts"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('sold_apartments') is-invalid @enderror"
                                   name="sold_apartments" value="{{$constructor->sold_apartments}}" autocomplete="sold_apartments"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('reserved_apartments') is-invalid @enderror"
                                   name="reserved_apartments" value="{{$constructor->reserved_apartments}}" autocomplete="reserved_apartments"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('available_apartments') is-invalid @enderror"
                                   name="available_apartments" value="{{$constructor->available_apartments}}" autocomplete="available_apartments"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('parking') is-invalid @enderror" name="parking"
                                   value="{{$constructor->parking}}" autocomplete="parking" placeholder="{{__('translations.parking')}}"
                                   autofocus>
                            @error('parking')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('available_parking') is-invalid @enderror"
                                   name="available_parking" value="{{$constructor->available_parking}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('underground_parking') is-invalid @enderror"
                                   name="underground_parking" value="{{$constructor->underground_parking}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('available_underground_parking') is-invalid @enderror"
                                   name="available_underground_parking" value="{{$constructor->available_underground_parking}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('office_space') is-invalid @enderror"
                                   name="office_space" value="{{$constructor->office_space}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('available_office_space') is-invalid @enderror"
                                   name="available_office_space" value="{{$constructor->available_office_space}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 mb-4 mb-sm-4">
                            <input data-date-format="dd-mm-yyyy" id="start_datepicker"
                                   ...
                                   value="{{$constructor->start_date}}" autocomplete="start_date"
                        ...
                        <div class="col-sm-4 mb-4 mb-sm-4">
                            <input data-date-format="dd-mm-yyyy" id="end_datepicker"
                                   ...
                                   value="{{$constructor->end_date}}" autocomplete="end_date"
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-3">
                            <label class="col-form-label text-gray-900"
                                   for="constructor_agency">{{__('translations.constructor')}} {{__('translations.agency')}}</label>
                        </div>
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="constructor_agency" class="form-control  @error('constructor_agency') is-invalid @enderror" id="constructor_agency">
                                <option>{{__('translations.constructor')}} {{__('translations.agency')}}</option>
                                @foreach($constructor_agencies as $constructor_agency)
                                    <option value="{{$constructor_agency->id}}" @if($constructor->const_agency_id==$constructor_agency->id) selected @endif >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="property_type" class="form-control @error('property_type') is-invalid @enderror" id="property_type">
                                <option></option>
                                <option {{$constructor->type == "house" ? "selected" : '' }} value="house">{{__('translations.house')}}</option>
                                <option {{$constructor->type == "building" ? "selected" : '' }} value="building">{{__('translations.building')}}</option>
                            </select>
                            @error('property_type')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-3">
                            <label class="col-form-label text-gray-900" for="floor_height">{{__('translations.floor_height')}}</label>
                        </div>
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="number" class="form-control @error('floor_height') is-invalid @enderror"
                                   name="floor_height" value="{{$constructor->floor_height}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="storeys" class="form-control @error('storeys') is-invalid @enderror" id="storeys">
                                ...
                                @for ($i = 1; $i <= 25; $i++)
                                    <option @if($constructor->storeys==$i) selected @endif
                                    value="{{ $i }}">{{ $i }}</option>
                                @endfor
                            </select>
                            @error('storeys')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="text" class="form-control @error('live_video_url') is-invalid @enderror"
                                   name="live_video_url" value="{{$constructor->live_video_url}}" autocomplete="live_video_url"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="distance_from_school" class="form-control @error('distance_from_school') is-invalid @enderror"
                                ...
                                <option value="0-300" {{$constructor->distance_from_school == "0-300" ? "selected" : '' }} >
                                    {{__('translations.before')}} 300
                                </option>
                                <option value="301-900" {{$constructor->distance_from_school == "301-900" ? "selected" : '' }} >
                                    300 - 900
                                </option>
                                <option value="901" {{$constructor->distance_from_school == "901" ? "selected" : '' }} >
                                    900 +
                                </option>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="distance_from_kindergarten" class="form-control @error('distance_from_kindergarten') is-invalid @enderror"
                                ...
                                <option value="0-300" {{$constructor->distance_from_kindergarten == "0-300" ? "selected" : '' }}>
                                    {{__('translations.before')}} 300
                                </option>
                                <option value="301-900" {{$constructor->distance_from_kindergarten == "301-900" ? "selected" : '' }}>
                                    300 - 900
                                </option>
                                <option value="901" {{$constructor->distance_from_kindergarten == "901" ? "selected" : '' }}>
                                    900 +
                                </option>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="distance_from_supermarket" class="form-control @error('distance_from_supermarket') is-invalid @enderror"
                                ...
                                <option value="0-300" {{$constructor->distance_from_supermarket == "0-300" ? "selected" : '' }}>
                                    {{__('translations.before')}} 300
                                </option>
                                <option value="301-900" {{$constructor->distance_from_supermarket == "301-900" ? "selected" : '' }}>
                                    300 - 900
                                </option>
                                <option value="901" {{$constructor->distance_from_supermarket == "901" ? "selected" : '' }}>
                                    900 +
                                </option>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="distance_from_pharmacy" class="form-control @error('distance_from_pharmacy') is-invalid @enderror"
                                ...
                                <option value="0-300" {{$constructor->distance_from_pharmacy == "0-300" ? "selected" : '' }}>
                                    {{__('translations.before')}} 300
                                </option>
                                <option value="301-900" {{$constructor->distance_from_pharmacy == "301-900" ? "selected" : '' }}>
                                    300 - 900
                                </option>
                                <option value="901" {{$constructor->distance_from_pharmacy == "901" ? "selected" : '' }}>
                                    900 +
                                </option>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <div class="row">
                                <input name="state" id="state" type="text" value="{{$constructor->state}}" hidden>
                                <input name="city" id="city" type="text" value="{{$constructor->city}}" hidden>
                                <div class="col-sm-6 mb-6 mb-sm-6">
                                    <select name="state_id" class="form-control" id="select_state">
                                        @foreach($states as $state)
                                            <option value="{{$state->id}}" {{$state->id == $constructor->state_id ? "selected" : ""}}> {{$state->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-6 mb-6 mb-sm-6">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-3">
                            <label class="col-form-label text-gray-900"
                                   for="address">{{__('translations.address')}}</label>
                        </div>
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <input type="text" class="form-control @error('address_en') is-invalid @enderror"
                                   name="address_en"  value="{{$constructor->translate('en')->address}}" id="address_en" placeholder="{{__('translations.address')}}" readonly>
                            <input type="text" class="form-control" value="{{$constructor->translate('ru')->address}}" name="address_ru" id="address_ru" readonly hidden>
                            <input type="text" class="form-control" value="{{$constructor->translate('am')->address}}" name="address_am" id="address_am" readonly hidden>
                            @error('address_en')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-3">
                            <input type="text" id="latitude" name="latitude" value="{{$constructor->latitude}}" hidden>
                            <input type="text" id="longitude" name="longitude" value="{{$constructor->longitude}}" hidden>
                        </div>
                        <div class="col-sm-9 mb-9 mb-sm-9">
        ...
        <script type="text/javascript">
            ...
            let images = {!! $constructor->constructorImages->toJson() !!};
            let initialPreviews = [];
            let initialPreviewConfigs = [];
            images.forEach(function (image) {
                initialPreviews.push('/storage/uploads/constructors/' + image.name)
            ...
            let main_image = '{{$constructor->main_image}}';
            let main_initialPreview = [];
            let main_initialPreviewConfig = [];
            if (main_image) {
                main_initialPreview = ['/storage/uploads/constructors/' + main_image];
            ...
            $(".kv-file-remove").click(function (e) {
                ...
                $.ajax({
                    type: "post",
                    url: "/admin/constructors/remove-image",
