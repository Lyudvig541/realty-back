        ...
        <div class="col-md-12 ">
            <div class="card shadow mb-4 ">
                <div class="card-header py-3">
                    <h4 class="h4 m-0 font-weight-bold text-primary text-center">{{__('translations.edit')}} {{__('translations.datas')}}</h4>
                </div>
                <div class="card-body">
                    <form class="user" method="POST" action="{{ route('update_user', $user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 mb-10 mb-sm-10">
                                <input type="number"
                                       ...
                                       name="limit" value="{{ $user->announcements_limit }}"
                                       required autocomplete="limit" id="limit"
                                       placeholder="{{__('translations.limit')}}">
                                @error('limit')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-sm-2 mb-2 mb-sm-2">
                                <label class="col-form-label text-gray-900" for="inputAddress">{{__('translations.role')}}</label>
                            </div>
                            <div class="col-sm-10 mb-10 mb-sm-10">
                        ...
                        <div class="card-footer text-center">
                            <button class="btn btn-sm btn-success" type="submit">{{__('translations.edit_person')}}</button>
                            <a href="{{route('users')}}" class="btn btn-sm btn-danger"> {{__('translations.cancel')}}</a>
                        </div>
                    </form>
                </div>
            </div>
