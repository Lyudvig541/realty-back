        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="h4 m-0 font-weight-bold text-primary text-center">{{ __('translations.create') }} {{ __('translations.comment') }}</h4>
                </div>
                <div class="card-body">
                    <form class="comments" method="POST" action="{{ route('store_comment')}}"
                                ...
                                <div class="row">
                                    <div class="col-12 nav-tabs-boxed">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 mb-10 mb-sm-10">
                                                <textarea type="text" class="form-control @error('text') is-invalid @enderror" name="text" value="{{old('text')}}"
