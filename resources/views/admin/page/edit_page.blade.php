    ...
    <div class="container">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="page" method="POST" action="{{ route('edit_page',$page->id)}}" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="col-12 nav-tabs-boxed">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text" class="form-control @error('title_'.$language) is-invalid @enderror"
                                                                   name="title_{{$language}}" value="{{$page->translate($language)->title}}" autocomplete="title_{{$language}}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mb-10 mb-sm-10">
                                                            <input type="text"
                                                                   ...
                                                                   autofocus value="{{$page->translate($language)->sub_title}}"/>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <textarea id="editor" class="form-control editor @error('editor_'.$language) is-invalid @enderror"
                                                                  name="editor_{{$language}}" autocomplete="editor_{{$language}}"
                                                                  placeholder="{{ __('translations.content') }}">{{$page->translate($language)->editor}}
                                                        </textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 mb-10 mb-sm-10">
                                                    <input type="text"
                                                           ...
                                                           name="slug" autocomplete="slug"
                                                           placeholder="{{ __('translations.slug') }}" autofocus
                                                           value="{{$page->slug}}"/>
                                                    @error('slug'.$language)
                                                    <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 mb-10 mb-sm-10">
                                                    <input id="image" class="form-control file-input @error('image') is-invalid @enderror"
        ...
        <script type="text/javascript">
            ...
            if (image){
                initialPreview = ['/storage/uploads/pages/' + image];
