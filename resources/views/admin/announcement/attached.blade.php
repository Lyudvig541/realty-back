                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <ul class="list-inline m-0">
                                                        ...
                                                        <li class="list-inline-item">
                                                            <a href="{{route('accept_announcement', $announcement->id)}}" class="btn btn-success btn-sm">
                                                                Accept
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a onclick="return confirm('Are you sure?')" href="{{route('decline_announcement', $announcement->id)}}" class="btn btn-danger btn-sm">
                                                                Decline
                                                            </a>
                                                        </li>
                                                    </ul>
