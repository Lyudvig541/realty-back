...
@section('content')
    <div class="container">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="announcements" method="GET" id="dropzoneForm" class="dropzone" action="{{route('take_announcement',$announcement->id)}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-12">
                            <div class="card-footer text-center">
                                <button class="btn btn-sm btn-success" type="submit">
                                    {{ __('translations.accept') }}
                                </button>
                                <a href="{{route('free_announcements')}}" class="btn btn-sm btn-danger">
