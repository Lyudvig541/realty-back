...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" media="all"
      rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.1/css/bootstrap-datepicker.min.css" integrity="sha512-vyxlyD6m54QfZ9PpnWfOHY8Lk3EcN1HuSYalLg3qqnqXLKTbRC/45lvy34WkngM1BUrYuJw1W1ZHlgEpdAn5Xg==" crossorigin="anonymous" referrerpolicy="no-referrer" />    .file-preview {
...
@section('content')
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 class="h4 m-0 font-weight-bold text-primary text-center">
                    {{ __('translations.verify') }}
                    {{ __('translations.announcement') }}
                </h4>
            </div>
            <div class="card-body">
                <form class="announcements" method="POST" id="dropzoneForm" class="dropzone" action="{{ route('verify_announcement', $announcement->id)}}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="user_id" class="form-control" id="user_id">
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{$user->id}}" @if($announcement->user_id == $user->id) selected @endif> {{$user->first_name}} {{$user->last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="inputAddress">{{__('translations.price')}}
                                </label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-6 mb-sm-6">
                                        <select name="currency" class="form-control" id="currency">
                                            @foreach($currencies as $currency)
                                                <option value="{{$currency->id}}" {{$currency->id == $announcement->currency_id ? "selected" : ""}}>
                                                    {{$currency->name}}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-lg-4 col-mg-4">
                                        <select name="rent_type" class="form-control" id="rent-type">
                                            <option {{$announcement->rent_type == "daily_rent" ? "selected" : ""}} value="daily_rent">
                                                {{__('translations.daily_rent')}}
                                            </option>
                                            <option {{$announcement->rent_type == "monthly_rent" ? "selected" : ""}} value="monthly_rent">
                                                {{__('translations.monthly_rent')}}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mb-4 mb-sm-4">
                                <input data-date-format="dd/mm/yyyy" id="start_datepicker"
                                       ...
                                       value="{{$announcement->start_date}}" autocomplete="start_date"
                            ...
                            <div class="col-sm-1 mb-1 mb-sm-1 text-center">-</div>
                            <div class="col-sm-4 mb-4 mb-sm-4">
                                <input data-date-format="dd/mm/yyyy" id="end_datepicker"
                                       class="form-control @error('end_date') is-invalid @enderror" name="end_date"
                                       value="{{$announcement->end_date}}" autocomplete="end_date"
                    ...
                    <div class="form-group row">
                        ...
                        @if($announcement->type->slug === "apartment" || $announcement->type->slug === "commercial")
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <select name="floor" class="form-control" id="floor">
                                    ...
                                    @for ($i = 0; $i <=24; $i++)
                                        <option value="{{ $i }}" {{$announcement->floor == $i ? "selected" : ""}}>
                                            {{ $i }}
                                        </option>
                                    @endfor
                                </select>
                        ...
                        @if($announcement->type->slug !== "land")
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <select name="storeys" class="form-control" id="storeys">
                                    <option value="">{{__('translations.storeys')}}</option>
                                    @for ($i = 0; $i <= 24; $i++)
                                        <option value="{{ $i }}" {{$announcement->storeys == $i ? "selected" : ""}}>
                                            {{ $i }}
                                        </option>
                                    @endfor
                                </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="distance_from_stations" class="form-control" id="distance_from_stations">
                                <option value="">{{__('translations.distance_from_stations')}}</option>
                                <option
                                    {{$announcement->distance_from_stations == "0-100" ? "selected" : ""}} value="0-100">
                                    {{__('translations.before')}} 100
                                </option>
                                <option
                                    {{$announcement->distance_from_stations == "101-300" ? "selected" : ""}} value="101-300">
                                    101 - 300
                                </option>
                                <option
                                    {{$announcement->distance_from_stations == "301" ? "selected" : ""}} value="301">
                                    301 +
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="sewer" class="form-control" id="sewer">
                                <option value="">{{__('translations.sewer')}}</option>
                                <option {{$announcement->sewer === "no_sewer" ? "selected" : ""}} value="no_sewer">
                                    {{__('translations.no_sewer')}}
                                </option>
                                <option {{$announcement->sewer === "individual" ? "selected" : ""}} value="individual">
                                    {{__('translations.individual')}}
                                </option>
                                <option {{$announcement->sewer == "centralised" ? "selected" : ""}} value="centralised">
                                    {{__('translations.centralised')}}
                                </option>
                            </select>
                        </div>
                    </div>
                    @if($announcement->type->slug !== "land")
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="rooms" class="form-control" id="rooms">
                                    ...
                                    @for ($i = 0; $i <= 7; $i++)
                                        <option value="{{ $i }}" {{$announcement->rooms == $i ? "selected" : ""}}>
                                            {{ $i }}
                                        </option>
                                    @endfor
                                </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 mb-9 mb-sm-9">
                                    <select name="bathroom" class="form-control" id="bathroom">
                                        ...
                                        @for ($i = 2; $i <= 8; $i++)
                                            <option value="{{ $i/2 }}" {{$announcement->bathroom == $i/2 ? "selected" : ""}}>
                                                {{ $i/2 }}
                                            </option>
                                        @endfor
                                    </select>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="building_type">{{__('translations.building_type')}}</label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="building_type" class="form-control" id="building_type">
                                    <option value="">{{__('translations.building_type')}}</option>
                                    <option {{$announcement->building_type == "monolith" ? "selected" : ""}} value="monolith">
                                        {{__('translations.monolith')}}
                                    </option>
                                    <option {{$announcement->building_type == "stone" ? "selected" : ""}} value="stone">
                                        {{__('translations.stone')}}
                                    </option>
                                    <option {{$announcement->building_type == "panel" ? "selected" : ""}} value="panel">
                                        {{__('translations.panel')}}
                                    </option>
                                    <option {{$announcement->building_type == "other" ? "selected" : ""}} value="other">
                                        {{__('translations.other')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="ceiling_height">{{__('translations.ceiling_height')}}</label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="ceiling_height" class="form-control" id="ceiling_height">
                        ...
                        @if($announcement->type->slug === "apartment")
                            <div class="form-group row">
                                <div class="col-sm-3 mb-3 mb-sm-3">
                                    <label class="col-form-label text-gray-900" for="condominium">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="condition" class="form-control" id="condition">
                                    ...
                                    <option {{$announcement->condition == "zero_condition" ? "selected" : ""}} value="zero_condition">
                                        {{__('translations.zero_condition')}}
                                    </option>
                                    <option {{$announcement->condition == "bad" ? "selected" : ""}} value="bad">
                                        {{__('translations.bad')}}
                                    </option>
                                    <option {{$announcement->condition == "middle" ? "selected" : ""}} value="middle">
                                        {{__('translations.middle')}}
                                    </option>
                                    <option {{$announcement->condition == "good" ? "selected" : ""}} value="good">
                                        {{__('translations.good')}}
                                    </option>
                                    <option {{$announcement->condition == "excellent" ? "excellent" : ""}} value="zero_condition">
                                        {{__('translations.excellent')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        @if($announcement->type->slug === "commercial")
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 mb-9 mb-sm-9">
                                    <select name="land_type" class="form-control" id="land_type">
                                        ...
                                        <option {{$announcement->land_type == "shops" ? "selected" : ""}} value="shops">
                                            {{__('translations.shops')}}
                                        </option>
                                        <option {{$announcement->land_type == "offices" ? "selected" : ""}} value="offices">
                                            {{__('translations.offices')}}
                                        </option>
                                        <option {{$announcement->land_type == "services" ? "selected" : ""}} value="services">
                                            {{__('translations.services')}}
                                        </option>
                                        <option {{$announcement->land_type == "other" ? "selected" : ""}} value="other">
                                            {{__('translations.other')}}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 mb-9 mb-sm-9">
                                    <select name="property_place" class="form-control" id="land_type">
                                        <option value="">{{__('translations.property_place')}}</option>
                                        <option {{$announcement->property_place == "into_building" ? "selected" : ""}} value="into_building">
                                            {{__('translations.into_building')}}
                                        </option>
                                        <option {{$announcement->property_place == "offices" ? "selected" : ""}} value="out_of_building">
                                            {{__('translations.out_of_building')}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        @if($announcement->type_id !== 4)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 mb-9 mb-sm-9">
                                    <select name="furniture" class="form-control" id="furniture">
                                        <option value="">{{__('translations.furniture')}}</option>
                                        <option {{$announcement->furniture == "true" ? "selected" : ""}} value="true">
                                            {{__('translations.yes')}}
                                        </option>
                                        <option {{$announcement->furniture == "false" ? "selected" : ""}} value="false">
                                            {{__('translations.no')}}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 mb-3 mb-sm-3">
                                    <label class="col-form-label text-gray-900"
                                           for="degree">{{__('translations.degree')}}
                                </div>
                                <div class="col-sm-9 mb-9 mb-sm-9">
                                    <select name="degree" class="form-control" id="degree">
                                        <option value="">{{__('translations.degree')}}</option>
                                        <option {{$announcement->degree == "0" ? "selected" : ""}} value="0">
                                            0
                                        </option>
                                        <option {{$announcement->degree == "1" ? "selected" : ""}} value="1">
                                            1
                                        </option>
                                        <option {{$announcement->degree == "2" ? "selected" : ""}} value="2">
                                            2
                                        </option>
                                        <option {{$announcement->degree == "3" ? "selected" : ""}}  value="3">
                                            3
                                        </option>
                                        <option {{$announcement->degree == "4" ? "selected" : ""}}  value="4">
                                            4
                                        </option>
                                    </select>
                                </div>
                        ...
                        @endif
                        @if($announcement->type_id === 1 ||$announcement->type_id === 2 )
                            <div class="form-group row">
                                <div class="col-sm-3 mb-3 mb-sm-3">
                                    <label class="col-form-label text-gray-900"
                                ...
                                <div class="col-sm-9 mb-9 mb-sm-9">
                                    <select name="balcony" class="form-control" id="balcony">
                                        <option value="">{{__('translations.balcony')}}</option>
                                        <option {{$announcement->balcony == "no_balcony" ? "selected" : ""}} value="no_balcony">
                                            {{__('translations.no_balcony')}}
                                        </option>
                                        <option {{$announcement->balcony == "open_balcony" ? "selected" : ""}} value="open_balcony">
                                            {{__('translations.open_balcony')}}
                                        </option>
                                        <option {{$announcement->balcony == "close_balcony" ? "selected" : ""}}  value="open_balcony">
                                            {{__('translations.close_balcony')}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="distance_from_medical_center" class="form-control"
                                    id="distance_from_medical_center">
                                <option value="">{{__('translations.distance_from_medical_center')}}</option>
                                <option {{$announcement->distance_from_medical_center == "0-1000" ? "selected" : ""}} value="0-1000">
                                    {{__('translations.before')}} 1000
                                </option>
                                <option {{$announcement->distance_from_medical_center == "1001" ? "selected" : ""}} value="1001">
                                    1001 +
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <select name="distance_from_metro_station" class="form-control" id="distance_from_metro_station">
                                <option value="">{{__('translations.distance_from_metro_station')}}</option>
                                <option {{$announcement->distance_from_metro_station == "0 - 100" ? "selected" : ""}} value="0 - 100">
                                    {{__('translations.before')}} 100
                                </option>
                                <option {{$announcement->distance_from_metro_station == "100 - 500" ? "selected" : ""}} value="100 - 500">
                                    100 - 500
                                </option>
                                <option {{$announcement->distance_from_metro_station == "no_metro" ? "selected" : ""}} value="no_metro">
                                    {{__('translations.no_metro')}}
                                </option>
                            </select>
                        </div>
                    </div>
                    @if($announcement->type->slug === "land")
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="land_geometric_appearance" class="form-control" id="land_geometric_appearance">
                                    <option {{$announcement->land_geometric_appearance == "0-2" ? "selected" : ""}} value="0-2">
                                        {{__('translations.smooth')}}
                                    </option>
                                    <option {{$announcement->land_geometric_appearance == "2-5" ? "selected" : ""}} value="2-5">
                                        2 - 5 {{__('translations.degrees')}}
                                    </option>
                                    <option {{$announcement->land_geometric_appearance == "5-10" ? "selected" : ""}} value="5-10">
                                        5 - 10 {{__('translations.stone')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="purpose">{{__('translations.front_position_length')}}</label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <input type="number"
                                       class="form-control @error('front_position_length') is-invalid @enderror"
                                       name="front_position_length"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="road_type" class="form-control" id="road_type">
                                    <option {{$announcement->road_type == "asphalt" ? "selected" : ""}} value='asphalt'>
                                        {{__('translations.asphalt')}}
                                    </option>
                                    <option {{$announcement->road_type == "ground" ? "selected" : ""}} value='ground'>
                                        {{__('translations.ground')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="front_position">{{__('translations.front_position')}}</label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="front_position" class="form-control" id="front_position">
                                    <option {{$announcement->front_position == "primary_and_secondary" ? "selected" : ""}} value='primary_and_secondary'>
                                        {{__('translations.primary_and_secondary')}}
                                    </option>
                                    <option {{$announcement->front_position == "primary " ? "selected" : ""}} value='primary'>
                                        {{__('translations.primary')}}
                                    </option>
                                    <option {{$announcement->front_position == "secondary" ? "selected" : ""}} value='secondary'>
                                        {{__('translations.secondary')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="infrastructure">{{__('translations.infrastructure')}}</label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="infrastructure" class="form-control" id="infrastructure">
                                    <option {{$announcement->infrastructure == "all_available" ? "selected" : ""}} value='all_available'>
                                        {{__('translations.all_available')}}
                                    </option>
                                    <option {{$announcement->infrastructure == "no_communication" ? "selected" : ""}} value='no_communication'>
                                        {{__('translations.no_communication')}}
                                    </option>
                                    <option {{$announcement->infrastructure == "all_available_except_irrigation_water" ? "selected" : ""}} value='all_available_except_irrigation_water'>
                                        {{__('translations.all_available_except_irrigation_water')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="fence_type" class="form-control" id="fence_type">
                                    <option {{$announcement->fence_type == "partly_fenced" ? "selected" : ""}} value='partly_fenced'>
                                        {{__('translations.partly_fenced')}}
                                    </option>
                                    <option {{$announcement->fence_type == "stone_fence" ? "selected" : ""}} value='stone_fence'>
                                        {{__('translations.stone_fence')}}
                                    </option>
                                    <option {{$announcement->fence_type == "no_fence" ? "selected" : ""}} value='no_fence'>
                                        {{__('translations.no_fence')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="purpose">{{__('translations.purpose')}}</label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="purpose" class="form-control" id="purpose">
                                    <option {{$announcement->front_position_length == "public_construction_of_settlements" ? "selected" : ""}} value='public_construction_of_settlements'>
                                        {{__('translations.public_construction_of_settlements')}}
                                    </option>
                                    <option {{$announcement->fence_type == "residential_construction_of_settlements" ? "selected" : ""}} value='residential_construction_of_settlements'>
                                        {{__('translations.residential_construction_of_settlements')}}
                                    </option>
                                    <option {{$announcement->fence_type == "mixed_construction_of_settlements" ? "selected" : ""}} value='mixed_construction_of_settlements'>
                                        {{__('translations.mixed_construction_of_settlements')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-3">
                                <label class="col-form-label text-gray-900"
                                       for="building">{{__('translations.building')}}
                                </label>
                            </div>
                            <div class="col-sm-9 mb-9 mb-sm-9">
                                <select name="building" class="form-control" id="building">
                                    <option {{$announcement->building == "there_is_building" ? "selected" : ""}} value='there_is_building'>
                                        {{__('translations.there_is_building')}}
                                    </option>
                                    <option {{$announcement->building == "there_is_not_building" ? "selected" : ""}} value='there_is_not_building'>
                                        {{__('translations.there_is_not_building')}}
                                    </option>
                                </select>
                                @error('building')
                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-6 mb-6 mb-sm-6">
                                    <select name="state_id" class="form-control" id="select_state">
                                        @foreach($states as $state)
                                            <option value="{{$state->id}}" {{$state->id == $announcement->state_id ? "selected" : ""}}>
                                                {{$state->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6 mb-6 mb-sm-6">
                                    <select name="city_id" class="form-control" id="select_city">
                                        @foreach($cities as $city)
                                            <option
                                                value="{{$city->id}}" {{$city->id == $announcement->city_id ? "selected" : ""}}> {{$city->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-9 mb-sm-9">
                            <div class="md-form">
                                <textarea id="description" class="md-textarea form-control" placeholder="{{__('translations.description')}}" rows="3" name="description">{{$announcement->description}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <script src="https://api-maps.yandex.ru/2.1/?apikey=26d57744-0383-4385-b157-eb26b080da07&lang=en_RU" type="text/javascript"></script>
